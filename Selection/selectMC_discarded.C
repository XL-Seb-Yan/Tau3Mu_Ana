...
void selectMC(const TString conf="samples.conf", // input file
  ...
  //TH1F* hist0 = new TH1F("tau -> 3 muon 0","MC RECO m_{#mu^{#pm}#mu^{#pm}#mu^{#pm}}",100,0,10);
  TH1F* hist0 = new TH1F("tau -> 3 muon 0","MC RECO m_{#mu^{+}#mu^{-}#pi^{#pm}}",100,0,10);
